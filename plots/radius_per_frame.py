"""
Droplet density analysis from LAMMPS dump data - Plot 2D radius value per frame module
"""
...
def radius_value_per_frame(frames, radius_values, output_html, output_png):
    ...
    fig.update_layout(
        ...
        showlegend=False,
        #title={
        #    'text': "Droplet Contact Radius Values",
        #    'x': 0.5,
        #    'y': 0.93,
        #    'xanchor': 'center',
        #    'yanchor': 'top'
